...
actor = Image.open(HERE / "ch-extra-commuter-waiting-r4-alpha.png").convert("RGBA")
...
# Same approved R3 pose placement, allowing direct face-age comparison.
...
canvas.save(HERE / "review-ch-extra-commuter-runtime-fhd-r4.png")
canvas.resize((1280, 720), Image.Resampling.LANCZOS).save(
    HERE / "review-ch-extra-commuter-runtime-720-r4.png"
)
