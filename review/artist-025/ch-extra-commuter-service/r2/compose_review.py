...
actor = Image.open(HERE / "ch-extra-commuter-waiting-r2-alpha.png").convert("RGBA")
...
# Seat-03 review centre. R2 is purpose-built as a counter-height character cutout,
# so place the waist below the foreground counter instead of inventing seated legs.
target_w, target_h = 215, 430
...
canvas.save(HERE / "review-ch-extra-commuter-runtime-fhd-r2.png")
canvas.resize((1280, 720), Image.Resampling.LANCZOS).save(
    HERE / "review-ch-extra-commuter-runtime-720-r2.png"
)
