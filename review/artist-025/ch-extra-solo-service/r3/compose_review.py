...
actor = Image.open(HERE / "ch-extra-solo-waiting-r3-alpha.png").convert("RGBA")
...
# Keep the smaller R2 scale and lower the seated pivot slightly for R3.
...
canvas.save(HERE / "review-ch-extra-solo-runtime-fhd-r3.png")
canvas.resize((1280, 720), Image.Resampling.LANCZOS).save(
    HERE / "review-ch-extra-solo-runtime-720-r3.png"
)
