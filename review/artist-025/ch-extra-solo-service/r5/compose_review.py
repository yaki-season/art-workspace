...
actor = Image.open(HERE / "ch-extra-solo-waiting-r5-alpha.png").convert("RGBA")
...
# Match the approved runtime framing. Raised forearms remain visible above the
# foreground counter while the seated body stays naturally occluded.
...
canvas.save(HERE / "review-ch-extra-solo-runtime-fhd-r5.png")
canvas.resize((1280, 720), Image.Resampling.LANCZOS).save(
    HERE / "review-ch-extra-solo-runtime-720-r5.png"
)
