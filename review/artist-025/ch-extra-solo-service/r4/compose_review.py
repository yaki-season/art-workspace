...
actor = Image.open(HERE / "ch-extra-solo-waiting-r4-alpha.png").convert("RGBA")
...
# Keep the compact display scale, lower the whole actor by 25px, and rely on the
# raised R4 forearms so both hands remain readable above runtime counter occlusion.
...
canvas.save(HERE / "review-ch-extra-solo-runtime-fhd-r4.png")
canvas.resize((1280, 720), Image.Resampling.LANCZOS).save(
    HERE / "review-ch-extra-solo-runtime-720-r4.png"
)
