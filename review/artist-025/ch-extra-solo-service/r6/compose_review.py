...
actor = Image.open(HERE / "ch-extra-solo-waiting-r6-alpha.png").convert("RGBA")
...
canvas.save(HERE / "review-ch-extra-solo-runtime-fhd-r6.png")
canvas.resize((1280, 720), Image.Resampling.LANCZOS).save(
    HERE / "review-ch-extra-solo-runtime-720-r6.png"
)
