...
module = Image.open(HERE / "st-service-counter-r1-alpha.png").convert("RGBA")
...
# Place the pass module in the near, player-side interior of the U-shaped
# counter rather than on the customer-facing crossbar.
...
canvas.save(HERE / "review-st-service-counter-runtime-fhd-r1.png")
canvas.resize((1280, 720), Image.Resampling.LANCZOS).save(
    HERE / "review-st-service-counter-runtime-720-r1.png"
)
