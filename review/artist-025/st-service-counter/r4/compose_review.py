...
module = Image.open(HERE / "st-service-counter-r4-alpha.png").convert("RGBA")
...
canvas.save(HERE / "review-st-service-counter-runtime-fhd-r4.png")
canvas.resize((1280, 720), Image.Resampling.LANCZOS).save(
    HERE / "review-st-service-counter-runtime-720-r4.png"
)
