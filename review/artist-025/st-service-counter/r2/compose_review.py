...
module = Image.open(HERE / "st-service-counter-r2-alpha.png").convert("RGBA")
...
# Preserve the user-approved player-side position from the final R1 review.
target_w = 1020
...
canvas.save(HERE / "review-st-service-counter-runtime-fhd-r2.png")
canvas.resize((1280, 720), Image.Resampling.LANCZOS).save(
    HERE / "review-st-service-counter-runtime-720-r2.png"
)
